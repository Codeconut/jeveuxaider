...
class InvitationSent extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        if ($this->invitation->role == 'responsable_collectivity') {
            $message
                ->line($this->invitation->user->profile->full_name . ' vous invite à rejoindre la collectivité ' . $this->invitation->invitable->name . ' sur la plateforme de dépôts de missions de la Réserve Civique.');
        }
